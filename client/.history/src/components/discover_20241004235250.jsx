          ...
          {properties.map((property) => (
            <div key={property.id} className="bg-white p-4 rounded-lg">
              ...
              <div className="mt-4 flex flex-col gap-2">
                ...
                <p className="text-sm text-[#0009297e]">{property.location}</p>

                <div className='w-full h-[1.5px] bg-[#F0EFFB]' />

                <div className="flex items-center gap-3 mt-2 font-jakarta font-medium text-[12px]">
                  <div className="flex items-center text-[#000929]">
