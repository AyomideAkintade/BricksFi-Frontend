                ...
                <div className="w-[60%] flex flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-3 font-jakarta">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="text-[#E4AA15] font-bold text-[18px]">{buyValue} SOL</div>
                        </div>
                    </div>
                ...
                <div className="flex-1">
                    <div className="mt-[100px] flex flex-col items-center gap-5 px-6 py-8 rounded-[32px]" style={{boxShadow:'1px 1px 32px -8px #0000001A'}}>
                        ...
                        <div className="flex flex-col gap-2 items-center">
                            <div className="font-inter text-[18px]">Total Property Price</div>
                            <div className="font-jakarta font-bold text-[25px]">{asset.value} SOL</div>
                        </div>
                        <div className="relative bg-[#F5F5F5] rounded-lg flex flex-col gap-4 p-8 w-full">
                            <div className="flex items-center justify-between">
                                <div className="">Percentage</div>
                                <div className="">{buyValue/asset.value * 100 || 0}%</div>
                            </div>
                        </div>
                        <button className="bg-[#E4AA15] rounded-xl text-[#FFFFFF] py-2 px-7">Connect Wallet</button>
                    </div>
                </div>
            </div>
