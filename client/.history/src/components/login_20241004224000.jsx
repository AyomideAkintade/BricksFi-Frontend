      ...
      <div className="bg-white rounded-lg w-full flex md:flex-row">
        ...
        <div className="w-full p-8">
          ...
          <div className="w-1/2 px-12 py-8 flex flex-col gap-6 text-[#313131]">
            ...
            <form className="flex flex-col gap-6" onSubmit={(e)=>handleSubmit}>
              <div className="">
              ...
              <button className="w-full bg-[#E4AA15] text-white py-3 rounded-md  transition duration-200 cursor-pointer">
                Login
              </button>
            </form>
