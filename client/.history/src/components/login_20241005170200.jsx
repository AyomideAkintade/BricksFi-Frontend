        ...
        const authCookie = new CookieData('authToken', data["token"], createCookieDate(data["expires_in"]));
          ...
          if(responseData["success"] === true){
            try {
              ...
              const keyCookie = new CookieData('accountKey', key, createCookieDate(data["expires_in"]));
              const idCookie = new CookieData('accountId', userId, createCookieDate(data["expires_in"]));      
