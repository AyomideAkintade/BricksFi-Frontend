                            ...
                            <div className="w-full absolute bottom-[-30px] flex justify-center">
                                ...
                                <div className="rounded-xl text-[#FFFFFF] py-3 px-9 cursor-pointer">

                                    {
                                        ...
                                        true ? 
                                            <button className="bg-[#E4AA15] rounded-xl text-[#FFFFFF] py-3 px-9 cursor-pointer w-[180px]" disabled={creatingAccount} onClick={createAccount}>Create Account</button>
                                            : 
                                        <button className="bg-[#E4AA15] rounded-xl text-[#FFFFFF] py-3 px-9 cursor-pointer w-[180px]" disabled={buyingAsset} onClick={buyAsset}>Buy</button>
