    ...
    return (
        <div className="flex flex-col gap-10">
            <div className="flex items-center gap-8">
                <div className="bg-white rounded-lg p-5 flex-1" style={{boxShadow: "rgba(34, 48, 62, 0.08) 1px 2px 20px -4px"}}>
                    <div className="w-full flex flex-col gap-1">
                         <div className="text-[#181819E5] font-bold text-[14px]">Total local shipments</div>
                        <div className="text-[#14142B] text-[26px] font-bold">2,420</div>
                    </div>
                </div>
                <div className="bg-white rounded-lg p-4 flex-1" style={{boxShadow: "rgba(34, 48, 62, 0.08) 1px 2px 20px -4px"}}>
                    <div className="w-full flex flex-col gap-1">
                        <div className="text-[#181819E5] font-bold text-[14px]">Total intl shipments</div>
                        <div className="text-[#14142B] text-[26px] font-bold">2,420</div>
                </div>
                </div>
            </div>
                    ...
                    <table className='table-auto w-full border-collapse border-[1px] border-[#E8E8E8]'>
                        ...
                        <tbody>
                            ...
                            <tr className="text-[#787389] font-Rubik text-[14.5px]" key={key} onClick={()=>{ navigate(`/discover/asset/${asset.key}`) }}>
                                ...
                                <td className="py-3 px-3 border-b-[1px]">${asset.amount_owned * (rate || 0)}</td>
