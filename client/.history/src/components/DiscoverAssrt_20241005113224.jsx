                ...
                <div className="w-[60%] flex flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-3 w-full">
                        <div className="relative w-full">
                            ...
                            <div className="absolute top-0 h-[4px] w-full rounded-lg z-[1]" style={{background: "linear-gradient(90deg, #E4AA15, #E4AA15) 0% 0% / 50% 100% no-repeat"}}></div>
                        </div>
                        <div className="flex items-center font-jakarta justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div className="text-[#E4AA15] font-medium text-[17px]">{46}% funded</div>
                            </div>
                            <div className="text-[#444444] text-[14px] font-medium">{asset.value - asset.value_bought} SOL available</div>
                        </div>
                    </div>
                </div>
