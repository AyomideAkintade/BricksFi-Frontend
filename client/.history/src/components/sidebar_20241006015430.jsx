...
import { IoBulbSharp, IoLogOut } from "react-icons/io5";
...
const Sidebar = () => {
  return (
    <aside className="bg-white h-screen w-[15%] fixed p-3 min-w-[200px]">
      ...
      <div to="/wallet" className="py-3 px-4 flex items-center text-gray-700 hover:bg-gray-200 rounded-lg">
              <IoLogOut className="mr-3 font-inter font-medium text-[#00000099]" /> Wallet
      </div>
    </aside>
  );
};
