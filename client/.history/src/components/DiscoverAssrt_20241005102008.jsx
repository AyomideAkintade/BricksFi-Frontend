                    ...
                    <div className="flex items-center border-2 border-[#D9D9D9] rounded-2xl">
                        {
                            ...
                            return <div className="w-full flex flex-col items-center gap-2 text-[#000929] border-inherit border-r-[1.5px] last:border-none p-4">
                                <div classname="text-[#807F7F] font-inter font-medium">{key}</div>
                                <div className="flex items-center gap-3 font-inter font-semibold">{icon} {value}</div>
                            </div>
                            })
                        }
                    </div>
