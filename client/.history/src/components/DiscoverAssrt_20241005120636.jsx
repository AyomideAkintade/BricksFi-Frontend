        ...
        <div className="flex flex-col gap-3">
            ...
            <div className="flex w-full gap-8">
                ...
                <div className="flex-1">
                    <div className="mt-[100px] flex flex-col items-center gap-3" style={{boxShadow:'1px 1px 32px -8px #0000001A'}}>
                        <div className="font-jakarta tracking-[2%] font-bold text-[25px]">Financial Summary</div>
                    </div>
                </div>
            </div>
