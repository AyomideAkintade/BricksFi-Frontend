        ...
        <div className="flex flex-col gap-3">
            ...
            <div className="flex w-full gap-8">
                <div className="w-2/3 flex flex-col gap-4">
                    ...
                    <div className="flex items-center border-2 border-[#D9D9D9]">
                        {
                            ...
                            return <div className="w-full flex flex-col items-center gap-2 text-[#000929] border-inherit border-r-[1.5px]">
                                <div className="p-4">
                                <div classname="text-[#807F7F] font-inter font-medium">{key}</div>
                                <div className="flex items-center gap-2">{icon} {value}</div>
                                </div>
                            </div>
                            })
                        }
