            ...
            <div className="grid grid-cols-2 gap-4" style={{}}>
                <div className="h-[300px]">
                    <div className="h-full">
                        <img className="rounded-[16px] object-cover h-full" src={asset.images[0]} alt={asset.name} />
                    </div>
                </div>
                <div className="grid grid-cols-2 gap-6 h-[300px]">
                    {
                        asset.images.slice(1).map((imageLink, key)=>{
                            return <img className="rounded-[16px] h-[150px] object-cover" key={key} src={imageLink} alt={asset.name} />
                        })
                    }
                </div>
            </div>
