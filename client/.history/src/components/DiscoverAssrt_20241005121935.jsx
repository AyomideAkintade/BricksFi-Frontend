                ...
                <div className="flex-1">
                    <div className="mt-[100px] flex flex-col items-center gap-5 px-6 py-8 rounded-[32px]" style={{boxShadow:'1px 1px 32px -8px #0000001A'}}>
                        ...
                        <div className="relative bg-[#F5F5F5] rounded-lg flex flex-col gap-4 py-8 px-5 w-full">
                            ...
                            <div className="w-full absolute bottom-[-100px] flex justify-center">
                                <button className="bottom-0 bg-[#E4AA15] rounded-xl text-[#FFFFFF] py-3 px-9">Connect Wallet</button>
                            </div>
                        </div>
                    </div>
                </div>
