            ...
            <div className="flex w-full gap-8">
                <div className="w-[60%] flex flex-col gap-4">
                    ...
                    <div className="flex items-center gap-4">
                        { isValidLink(asset.virtual_link)  && <Link to={asset.virtual_link} className="w-full flex p-2 items-center gap-3 bg-[#DDA72233] rounded-lg">
                            ...
                            <div className="font-jakarta text-[18px] font-semibold">Virtual Tour</div>
                        </Link> }
                    </div>
                </div>
