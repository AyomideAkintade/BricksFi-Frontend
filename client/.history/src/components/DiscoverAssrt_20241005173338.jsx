                ...
                <div className="w-[60%] flex flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-3 w-full">
                        <div className="relative w-full">
                            ...
                            <div className="absolute top-0 h-[4px] w-full rounded-lg z-[1]" style={{background: `linear-gradient(90deg, #E4AA15, #E4AA15) 0% 0% / 90% ${100 - ((asset.value - asset.value_bought)/asset.value * 100)}% no-repeat`}}></div>
                        </div>
