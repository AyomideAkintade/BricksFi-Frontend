        ...
        <div className="flex flex-col gap-3">
            <div className="flex w-full gap-6">
                <div className="w-full">
                    <div className="">
                        <img className="rounded-[16px] h-full" src={asset.images[0]} alt={asset.name} />
                    </div>
                </div>
                <div className="w-full grid grid-cols-2 gap-4">
                    {
                        asset.images.slice(1).map((imageLink, key)=>{
                            return <img className="rounded-[16px] w-full h-full" key={key} src={imageLink} alt={asset.name} />
                        })
                    }
                </div>
            </div>
