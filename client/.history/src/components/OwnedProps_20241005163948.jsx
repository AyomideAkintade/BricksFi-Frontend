            ...
            <div className="flex items-center gap-8">
                ...
                <div className="bg-white rounded-lg px-4 py-7 flex-1" style={{boxShadow: "rgba(34, 48, 62, 0.08) 1px 2px 20px -4px"}}>
                    <div className="w-full flex flex-col gap-1">
                        ...
                        <div className="text-[#14142B] text-[26px] font-bold">${(amountsOwned.reduce((a, b) => a + b, 0)) * (rate || 0)}</div>
                </div>
                </div>
            </div>
                    ...
                    <table className='table-auto w-full border-collapse border-[1px] border-[#E8E8E8]'>
                        ...
                        <tbody>
                            ...
                            <tr className="text-[#787389] font-Rubik text-[14.5px]" key={key} onClick={()=>{ navigate(`/discover/asset/${asset.key}`) }}>
                                ...
                                <td className="py-3 px-3 border-b-[1px]">{console.log(asset.amount_owned , asset.details.value)}{asset.amount_owned / asset.details.value * 100}%</td>
