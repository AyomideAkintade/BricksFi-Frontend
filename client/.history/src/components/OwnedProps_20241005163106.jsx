    ...
    return (
        <div className="flex flex-col gap-10">
            <div className="flex items-center gap-8">
                <div className="bg-white rounded-lg px-4 py- flex-1" style={{boxShadow: "rgba(34, 48, 62, 0.08) 1px 2px 20px -4px"}}>
                ...
                <div className="bg-white rounded-lg px-4 py-7 flex-1" style={{boxShadow: "rgba(34, 48, 62, 0.08) 1px 2px 20px -4px"}}>
                    <div className="w-full flex flex-col gap-1">
                        ...
                        <div className="text-[#14142B] text-[26px] font-bold">${amountsOwned * (rate || 0)}</div>
                </div>
                </div>
            </div>
