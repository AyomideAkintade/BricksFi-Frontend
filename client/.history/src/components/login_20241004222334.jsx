        ...
        <div className="w-full p-8">
          ...
          <div className="w-1/2 px-12 py-8 flex flex-col gap-6 text-[#313131]">
            ...
            <form className="flex flex-col gap-6">
              ...
              <button  onClick={handleLoginClick} className="w-full bg-[#E4AA15] text-white py-3 rounded-md  transition duration-200 cursor-pointer">
                Login
              </button>
            </form>
            ...
            <div className="flex flex-col items-center gap-8">
              <div className="">
                <p className="text-sm text-[#313131] whitespace-break-spaces">
