            ...
            <div className="flex w-full gap-8">
                <div className="w-[60%] flex flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-3 w-full relative">
                        <div className="bg-[#ECECEB] h-[5px] w-full absolute top-0 rounded-lg"></div>
                        <div className="absolute top-0 h-[5px] w-full rounded-lg z-[1]" style={{background: "linear-gradient(90deg, rgb(65, 191, 241), rgb(65, 191, 241)) 0% 0% / 50% 100% no-repeat"}}></div>
                    </div>
                </div>
