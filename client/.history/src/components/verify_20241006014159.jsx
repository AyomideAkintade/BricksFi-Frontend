...
export default function Verify(){
    ...
    const handleVerify = async ()=>{
        ...
        if(String(code).length !== 6 || isNaN(code)){
          ...
          <div className="bg-white rounded-lg w-full flex md:flex-row">
            ...
            <div className="w-full p-8">
              ...
              <div>
                ...
                <button type="submit" className="w-full bg-[#E4AA15] text-white py-3 rounded-md  transition duration-200 cursor-pointer disabled:bg-gray-700" onClick={handleVerify} disabled={disableButton}>
                  Verify
                </button>
            </div>
