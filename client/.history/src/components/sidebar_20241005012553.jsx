    ...
    <aside className="bg-white h-screen w-[15%] fixed p-3 min-w-[200px]">
      ...
      <nav className="mt-8">
        <ul className="space-y-4">
          ...
          <li className="p-4 hover:bg-yellow-100">
            <Link to="/discover" className="flex items-center text-gray-700">
              <RiCompassDiscoverLine className="mr-3" /> Discover
            </Link>
          </li>
          <li className="p-4 hover:bg-yellow-100">
            <Link to="/saved-property" className="flex items-center text-gray-700">
          ...
          <li className="p-4 hover:bg-yellow-100">
            <Link to="/wallet" className="flex items-center text-gray-700">
