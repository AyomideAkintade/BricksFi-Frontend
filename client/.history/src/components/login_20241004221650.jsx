          ...
          <div className="w-1/2 px-12 py-8 flex flex-col gap-6 text-[#313131]">
            ...
            <div className="flex flex-col items-center gap-8">
              ...
              <div className="flex justify-center gap-6 w-full">
                <button className="py-4 border-[1] border-[#E4AA15] w-full rounded-full text-yellow-500 hover:bg-gray-100 transition duration-200 flex items-center justify-center">
                  <FaFacebook size={20} />
                </button>
                <button className="py-4  border-[1] border-[#E4AA15] rounded-full w-full text-yellow-500 hover:bg-gray-100 transition duration-200 flex items-center justify-center">
                  <FaGoogle size={20} />
                </button>
                <button className="py-4  border-[1] border-[#E4AA15] rounded-full w-full text-yellow-500 hover:bg-gray-100 transition duration-200 flex items-center justify-center">
                  <FaApple size={20} />
