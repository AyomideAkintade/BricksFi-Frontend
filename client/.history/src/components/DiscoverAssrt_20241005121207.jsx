        ...
        <div className="flex flex-col gap-3">
            ...
            <div className="flex w-full gap-8">
                ...
                <div className="flex-1">
                    <div className="mt-[100px] flex flex-col items-center gap-3 px-6 py-8 rounded-[32px]" style={{boxShadow:'1px 1px 32px -8px #0000001A'}}>
                        ...
                        <div className="flex flex-col gap-2 items-center">
                            ...
                            <div className="font-jakarta font-bold text-[25px]">{buyValue} SOL</div>
                        </div>
                        <div className="h-[1px] bg-[#D9D9D9] w-full" />
