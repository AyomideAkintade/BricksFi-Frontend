            ...
            <form>
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border-[1px] text-sm rounded-md outline-none border-[#79747E]"
                />
              </div>
              <div className="mb-4">
                ...
                <input
                  type="password"
                  placeholder="••••••••••••"
                  className="w-full px-4 py-2 border-[1px] rounded-md outline-none border-[#79747E]"
                />
              </div>
